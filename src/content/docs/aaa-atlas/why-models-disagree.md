---
title: "Why climate models disagree"
description: "Why two climate models running the same emissions scenario produce different answers — and why that disagreement is real information, not noise."
area: AAA Adaptation Atlas
version: "0.1-stub"
estimatedReadingMinutes: 12
sidebar:
  order: 7
  label: "Why they disagree"
tableOfContents:
  minHeadingLevel: 2
  maxHeadingLevel: 3
---
...
- [Hawkins & Sutton 2009 — Sources of uncertainty](https://doi.org/10.1175/2009BAMS2607.1)
- [Hausfather et al. 2022 — Hot model problem](https://doi.org/10.1038/d41586-022-01192-2)
- [AR6 WGI Ch 4 — Future global climate projections](https://www.ipcc.ch/report/ar6/wg1/chapter/chapter-4/)
